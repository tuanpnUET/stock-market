...
const AccountView = () => {
    ...
    return (
        <View style={styles.container}>
            <FormProvider {...form}>
                <StyledInputForm
                    name={t('accountView.name')}
                    label="Username"
                    returnKeyType="next"
                    onChangeText={onChangeUsername}
                />
                <StyledInputForm name={t('accountView.email')} label="Email" />
                <StyledInputForm name={t('accountView.phone')} label="Phone Number" />
                <StyledInputForm secureTextEntry={true} name={t('accountView.password')} label="Password" />
                <StyledInputForm
                    name={t('accountView.confirmPassword')}
